...
def parse_infile(infile):
    ...
    with open(infile) as csvfile:
        ...
        return(eachspecies, ref_genomes, repr_genomes, chromosomes, scaffolds, tax_dict)
...
def select_genomes(eachspecies, ref_genomes, repr_genomes, chromosomes, scaffolds, taxa_id, maxgenomes, outgenomes, outproteins, outtaxa):
...
def main(infile, outgenomes, outproteins, outtaxa, maxgenomes):
    ...
    select_genomes(eachspecies, ref_genomes, repr_genomes, chromosomes, scaffolds, taxa_id, maxgenomes, outgenomes, outproteins, outtaxa)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--outtaxa', help='tsv file to be created with the taxon id for each file')
